 ...
 */
 ...
 [_QWERTZ] = LAYOUT(
  KC_ESC,   KC_RBRC,KC_LBRC,KC_LPRN, KC_RPRN,  KC_DQUO,                  KC_DLR  , KC_PERC, KC_AMPR, KC_PIPE , KC_QUES, KC_HASH,
...
[_RAISE] = LAYOUT(
  KC_AGIN, KC_UNDO, KC_CUT, KC_COPY, KC_PSTE, KC_FIND,                       KC_P1   , KC_P2   , KC_P3    ,KC_PSLS, KC_UP   , KC_ASTR,
